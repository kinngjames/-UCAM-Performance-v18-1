...
function buildMetrics(
  ...
  const wellbeingIndex = new Map<string, WellbeingRecord>();
  const planIndex = new Map<string, SessionPlan>();
  const matchIndex = new Map<string, MatchRecord>();
  const availabilityIndex = new Map<string, AvailabilityRecord>();
...
export default function Home() {
  ...
  const rosterMetrics = useMemo(
    () => buildMetrics(roster, sessions, wellbeing, plans, matches, availability, thresholds),
